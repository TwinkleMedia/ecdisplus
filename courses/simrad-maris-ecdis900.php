    ...
    <section class="info-card">
        ...
        <section class="info-card">
            ...
            <ul class="feature-list">
                ...
                <li>Advanced route planning and optimization tools, including special-purpose modules like SAR planning</li>
                ...
                <li>Supports ENCs (PRIMAR, IC-ENC, UKHO AVCS), UKHO ARCS, CMap Professional+ charts, and AIO (Admiralty Information Overlay) </li>
