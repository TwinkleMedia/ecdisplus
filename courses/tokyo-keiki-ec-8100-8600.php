...
<body>
    ...
    <div class="main-container">
        <section class="info-card">
            <h2 class="info-card-title"><i class="fas fa-info-circle"></i>Tokyo-keiki-ec-8100-8600</h2>
            <P>The Tokyo Keiki EC-8100/8600 type-specific training course provides officers with the system knowledge
                required to use this ECDIS for watchkeeping in accordance with the regulations of STCW and the ISM Code.
                The guided tutorial, with a duration of approx. 16 hours, covers the equipment familiarisation
                requirements of IMO Model Course 1.27 and MCA MIN-503(M) for the functions and controls of the ECDIS
                Tokyo Keiki EC-8100/8600. A course booking provides you with a three-week time frame to complete the
        ...
        <div class="main-container">
            ...
            <section class="info-card">
                ...
                <P>
                    As a pioneering manufacturer of navigational products for the marine industry for over a century,
                    TOKYO KEIKI provides total bridge equipment solutions and safe guidance to final destinations for
                    vessels all around the world. TOKYO KEIKI was the first manufacturer in Japan to make Electronic
                    Chart Systems over 20 years ago. Today, TOKYO KEIKI supports its customers from main locations like
                    Tokyo,
