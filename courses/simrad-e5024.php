...
<div class="main-container">
        ...
        <div class="module-details-container">
            <div class="module-box">
                <h2 class="module-box-title">
                    <i class="fas fa-book"></i>
                    Course Modules
                </h2>
                <ul class="module-details-list">
                    <li>Module 1: Exploring the User Interface</li>
                    <li>Module 2: Unveiling ECDIS Basic Display Features</li>
                    <li>Module 3: Understanding Sensors</li>
                    <li>Module 4: Mastering Chart Work</li>
                    <li>Module 5: Crafting Artful Route Planning</li>
                    <li>Module 6: Vigilant Route Monitoring</li>
                    <li>Module 7: Navigational Tools Demystified</li>
                    <li>Module 8: Chart Maintenance Essentials</li>
                    <li>Module 9: Navigating Data Management and Backup Arrangements</li>
                    <li>Module 10: Delving into the Display of Additional Information</li>
                </ul>
            </div>
        </div>

        <section class="audience-target">
            <div class="audience-element">
                <i class="fas fa-users"></i>
                <div>
                    <h3>Suitable For</h3>
                    <p>All officers of the team involved in ensuring the safe navigation of the vessel.</p>
                </div>
            </div>
            <div class="audience-element">
                ...
                <div>
                    <h3>Prerequisites</h3>
                    <p>ECDIS Generic knowledge, as per STCW and IMO Model Course 1.27</p>
                </div>
            </div>
        </section>
        ...
        <div class="equipment-list">
            <div class="equipment-item">
                <h3><i class="fas fa-desktop"></i> System Features</h3>
                <ul class="equipment-features">
                    <li>24-inch, Full-HD 16:9 widescreen for large, clear charts</li>
                    <li>Wireless trackball controller with on-screen keyboard</li>
                    <li>Third-party chart support</li>
                    <li>Choice between S-52 and INT1 chart presentation</li>
                    <li>Simple dual-station PLECDIS option</li>
                    <li>Optional secondary display</li>
                    <li>Radar, AIS, and ARPA overlay</li>
                    <li>Supports AIO (Admiralty Information Overlay)</li>
                </ul>
            </div>
        </div>
