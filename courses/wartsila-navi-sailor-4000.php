        ...
        <div class="main-container">
            ...
            <div class="equipment-list">
                <div class="equipment-item">
                    <h3><i class="fas fa-desktop"></i> Features</h3>
                    <ul class="equipment-features">
                        <li>The key choice for most deck officers and mariners</li>
                        <li> Compliant with the latest IMO regulations for ECDIS</li>
                        <li>Navi-Sailor’s supreme software combined with high-performance hardware</li>
                        <li>Supported by a truly worldwide service and spare part network</li>
                        <li>Available training around the world and online</li>
                        <li>Includes all accessories for installation</li>
                        <li>Ready to upgrade to Fleet Operation System</li>
                        <li>Ensures safe and efficient navigation</li>
                        <li>Features intuitive and advanced route planning</li>
                        <li>Ready for chart and data packages</li>
                        <li>Offers connectivity and cybersecurity</li>
