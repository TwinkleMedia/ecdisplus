...
<body>
    ...
    <div class="main-container">
        <section class="info-card">
            <h2 class="info-card-title"><i class="fas fa-info-circle"></i>Sperry Marine VisionMaster
            </h2>
        ...
        <section class="info-card">
            <h2 class="info-card-title"><i class="fas fa-info-circle"></i>Equipment Manufacturer
