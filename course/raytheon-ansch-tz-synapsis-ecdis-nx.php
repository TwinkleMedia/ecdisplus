...
<body>
    ...
    <div class="main-container">
        <section class="info-card">
            ...
            <p>The Raytheon Anschütz Synapsis ECDIS NX type-specific training course provides officers with the system
                ...
                requirements of IMO Model Course 1.27 and MCA MIN-503(M) for the functions and controls of the Synapsis
                ECDIS NX. A course booking provides you with a three-week time frame to complete the course, repeating
                Modules where necessary, and to use the “FreePlay” Mode, which allows you to practice freely on the
        ...
        <section class="info-card">
            ...
            <p>The objectives of this course are to cover type-specific familiarisation of ECDIS tailored to the
                ...
                before boarding a vessel, which ultimately translates to safer operations and vessel manoeuvring</p>
        </section>

        <section class="info-card">
            <h2 class="info-card-title"><i class="fas fa-users"></i>Suitable For</h2>
            <p>This course is designed for all officers of the bridge team involved in ensuring the safe navigation of
                the vessel.</p>
        </section>
